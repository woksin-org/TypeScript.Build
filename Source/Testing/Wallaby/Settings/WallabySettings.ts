...
export class WallabySettings {
    ...
    static get instrumentedNodeModules() {
        return [
            'chai',
            'chai-as-promised',
            'sinon',
    ...
    private getBaseInstrumentedFiles() {
        ...
        return baseFiles.concat(WallabySettings.instrumentedNodeModules.map(_ => {
    ...
    private getBaseIgnoredFiles() {
        ...
        const scopedPackages = WallabySettings.instrumentedNodeModules.filter(_ => _.startsWith('@'));
        const unscopedPackages = WallabySettings.instrumentedNodeModules.filter(_ => !_.startsWith('@'));
